...
# cpus_to_use, num_concurrent_predictions, intra, inter, station_count = find_optimal_configuration_cpu(4, 3, False, '/home/skevofilaxc/eqcctpro/csv/')
...
# cpus_to_use, num_concurrent_predictions, intra, inter, num_gpus, vram, station_count = find_optimal_configuration_gpu(5, 1, 2, True, '/home/skevofilaxc/eqcctpro/csv/')
